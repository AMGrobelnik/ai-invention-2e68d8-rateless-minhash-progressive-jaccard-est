...
A new way to estimate how similar two sets are by progressively generating hash values, like fountain codes in data transmission, allowing adaptive stopping when enough accuracy is reached.
