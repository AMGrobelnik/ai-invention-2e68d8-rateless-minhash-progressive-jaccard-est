...
- **2. test_idea** — `invention_loop`
  - round_1
    ...
    - `2_gen_plan/` — 3 task(s)
      - `chat/prompts/2_test_idea/round_1/2_gen_plan/gen_plan_dataset_1.md` — 9 prompts
      - `chat/prompts/2_test_idea/round_1/2_gen_plan/gen_plan_experiment_1.md` — 7 prompts
      - `chat/prompts/2_test_idea/round_1/2_gen_plan/gen_plan_research_1.md` — 9 prompts
    - `3_gen_art/` — 3 task(s)
      - `chat/prompts/2_test_idea/round_1/3_gen_art/gen_art_dataset_1.md` — 11 prompts
      - `chat/prompts/2_test_idea/round_1/3_gen_art/gen_art_experiment_1.md` — 10 prompts
  ...
  - round_2
    ...
    - `2_gen_plan/` — 2 task(s)
      ...
      - `chat/prompts/2_test_idea/round_2/2_gen_plan/gen_plan_proof_1.md` — 6 prompts
    - `3_gen_art/` — 2 task(s)
      - `chat/prompts/2_test_idea/round_2/3_gen_art/gen_art_experiment_1.md` — 10 prompts
      - `chat/prompts/2_test_idea/round_2/3_gen_art/gen_art_proof_1.md` — 7 prompts
